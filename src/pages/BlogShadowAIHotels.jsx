  ...
  return (
    <>
      <SEO
        ...
        ogDescription="Shadow AI im Hotelbetrieb: Risiken, Datenschutz und drei pragmatische Schritte für Hotel-Manager."
        ...
        jsonLd={[{
          ...
          "description": "Shadow AI im Hotelbetrieb: Was Mitarbeiter eigenständig nutzen, welche Risiken entstehen und drei pragmatische erste Schritte für Hotel-Manager."
        }, {
          "@context": "https://schema.org",
          "@type": "FAQPage",
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Beides. Die Compliance-Dimension entsteht, wenn Gästedaten in externe KI-Systeme eingegeben werden, ohne dass eine gültige Datenverarbeitungsvereinbarung vorliegt. Die Management-Dimension entsteht, wenn Kommunikationsqualität und Markenkonsistenz nicht mehr steuerbar sind."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Erfahrungsgemäß 60–90 Minuten: 30 Minuten Teamrunde, 30–60 Minuten strukturierte Aufbereitung. Kein IT-Projekt, kein externer Berater erforderlich."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Der erste Schritt — ein 30-minütiges Gespräch — ist kostenfrei. Ein strukturierter AI Readiness Check mit schriftlichem Ergebnis ist als separates Angebot verfügbar."
              }
            }
          ]
        }]}
      ...
      <section className="bg-navy-900 py-16">
        <div className="container-main max-w-3xl">
          ...
          <p className="text-white/60 text-lg leading-relaxed mb-6">
            Für Hotel-Manager und Operations-Teams — ohne Rechtssprache, ohne Panikmache.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 max-w-5xl mx-auto">
            ...
            <article className="lg:col-span-3 prose prose-slate max-w-none">
              ...
              <p className="text-lg text-slate-700 leading-relaxed font-medium">
                ...
                Fast alle beschreiben dieselbe Situation: <em>Ihre Mitarbeiter nutzen KI-Tools — aber niemand weiß genau, welche, wofür und welche Gästedaten dabei eingegeben werden.</em>
              </p>
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                intuitiv und auf jedem Smartphone. Was häufig fehlt, ist nicht die Nutzung — es ist die Struktur darum herum.
              </p>

              <h2 className="text-2xl font-bold text-navy-900 mt-10 mb-4">Was Shadow AI im Hotel konkret bedeutet</h2>
              <p className="text-slate-600 leading-relaxed">
                Shadow AI beschreibt eine einfache Situation: Mitarbeiter nutzen KI-Tools eigenständig,
                ohne dass Unternehmensleitung oder IT weiß, welche Tools eingesetzt werden, welche Daten
                dort eingegeben werden und ob diese Nutzung mit internen Richtlinien oder externen
                Anforderungen vereinbar ist.
              </p>
              <p className="text-slate-600 leading-relaxed">
                Das ist strukturell dasselbe Phänomen wie "Shadow IT" vor 15 Jahren. Der Unterschied:
                KI-Tools verarbeiten Sprache — und Sprache enthält Kontext, Gästedaten und
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  },
                  {
                    ...
                    text: 'Eine Operations-Managerin nutzt ein KI-Tool, um eine schwierige Gästebeschwerde zu formulieren. Sie kopiert die originale Nachricht des Gastes — inklusive Name und Kontaktdaten — in das Tool. Ob das Tool über eine Datenverarbeitungsvereinbarung verfügt, bleibt ungeklärt.',
                  },
                  {
                    title: 'Marketingtexte und Social Media',
                    text: 'Das Marketingteam verwendet KI-gestützte Tools für Beschreibungen und Posts. Die generierten Texte sind möglicherweise nicht einheitlich mit der geprüften Markenkommunikation des Hauses abgestimmt.',
                  },
                  {
                    title: 'Uebersetzungen',
                    text: 'Mehrsprachige Gästekorrespondenz wird durch Mitarbeiter in Google Translate oder DeepL übersetzt — beide inzwischen mit KI-Komponenten. Vertrauliche Buchungsdetails passieren dabei externe Server.',
                  },
                  {
                    title: 'Revenue Management mit KI-Funktionen',
                    text: 'Einige Revenue-Management-Systeme haben KI-basierte Preisempfehlungen integriert. Deren Einordnung unter datenschutzrechtlichen und regulatorischen Gesichtspunkten ist je nach Anbieter und Konfiguration unterschiedlich — und in vielen Häusern noch nicht formell geprüft.',
                  },
                ].map((item, i) => (
              ...
              <p className="text-slate-600 leading-relaxed">
                Wenn Ihr Team KI-Tools nutzt — ob eingekauft oder eigenständig mitgebracht — und diese
                Tools mit Gästedaten arbeiten, könnte daraus eine Dokumentationspflicht entstehen.
                Die genaue Einordnung hängt vom jeweiligen System und dessen Nutzungskontext ab.
              </p>
              <p className="text-slate-600 leading-relaxed">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 my-8">
                ...
                <p className="text-amber-700 text-sm leading-relaxed mb-3">Können Sie diese drei Fragen heute beantworten?</p>
                <ul className="space-y-2 text-sm text-amber-800">
                  <li className="flex items-start gap-2"><span className="text-amber-500 mt-0.5">→</span> Welche KI-Tools werden in Ihrem Betrieb genutzt — offiziell und eigenständig?</li>
                  <li className="flex items-start gap-2"><span className="text-amber-500 mt-0.5">→</span> Werden dabei Gästedaten eingegeben?</li>
                  <li className="flex items-start gap-2"><span className="text-amber-500 mt-0.5">→</span> Haben Sie für diese Tools gültige Datenverarbeitungsvereinbarungen?</li>
                </ul>
              </div>
                ...
                {[
                  {
                    ...
                    text: 'Gästedaten werden in externe KI-Systeme eingegeben, die möglicherweise nicht über eine gültige Datenverarbeitungsvereinbarung verfügen. Das ist ein konkretes Risiko, das durch klare Richtlinien und eine bewusste Tool-Auswahl adressierbar ist.',
                  },
                  {
                    n: '02',
                    title: 'Unkontrollierter Kommunikationsstil',
                    text: 'Wenn verschiedene Mitarbeiter mit unterschiedlichen KI-Tools Gästekommunikation verfassen, ist ein einheitliches Kommunikationsbild schwer aufrechtzuerhalten — besonders in kritischen Momenten wie Beschwerden oder Upgrade-Kommunikation.',
                  },
                  {
                    n: '03',
                    title: 'Fehlende Dokumentationsgrundlage',
                    text: 'Ohne Inventar und Dokumentation fehlt die Grundlage für eine saubere Einschätzung, welche KI-Systeme in Ihrem Betrieb eingesetzt werden und welche Anforderungen dabei relevant sein könnten.',
                  },
                ].map((step) => (
              ...
              <p className="text-slate-600 leading-relaxed mb-6">
                Shadow AI löst man nicht durch Verbote. Mitarbeiter werden KI-Tools nutzen — die Frage
                ...
                {[
                  {
                    ...
                    text: 'Bitten Sie Ihr Team in einem offenen Gespräch — kein Audit, keine Konsequenzen — eine Liste aller KI-Tools zu erstellen, die beruflich genutzt werden. Erfahrungsgemäß kommen dabei 8–15 Tools zusammen, von denen die Unternehmensleitung 2–3 kannte.',
                  },
                  {
                    n: '02',
                    title: 'Daten-Check je Tool',
                    text: 'Für jedes Tool eine einfache Frage: Werden dabei Gästedaten eingegeben? Name, E-Mail, Buchungsdetails, Beschwerden — ja oder nein? Das reduziert die relevante Liste schnell auf 3–5 Tools, bei denen eine genauere Prüfung sinnvoll ist.',
                  },
                  {
                    n: '03',
                    title: 'Einfache Richtlinie statt Verbot',
                    text: 'Eine einzige Regel kann das Datenschutzrisiko erheblich reduzieren: keine Gästedaten in nicht-geprüften KI-Tools. Keine aufwendige Policy, kein IT-Rollout. Eine klare Festlegung, kommuniziert und dokumentiert.',
                  },
                ].map((step) => (
                  <div key={step.n} className="flex gap-5 items-start bg-slate-50 rounded-xl p-5 border border-slate-100">
                    <span className="text-2xl font-bold text-gold-400 shrink-0 w-10">{step.n}</span>
              ...
              <p className="text-slate-400 text-xs leading-relaxed mt-8 pt-6 border-t border-slate-100">
                ...
                Er ersetzt keine rechtliche Einzelfallprüfung. Für Fragen zur DSGVO-Compliance oder
            ...
            <aside className="lg:col-span-1 space-y-5">
              <div className="bg-navy-900 rounded-2xl p-5 text-center sticky top-20">
                ...
                <p className="text-white/50 text-xs mb-4">30 Min. · Einzelgespräch · für Hotel-Betreiber</p>
                <a
      ...
      <section className="bg-navy-900 py-16">
        <div className="container-main text-center max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-4">
            Wissen, was in Ihrem Betrieb läuft.
          </h2>
          <p className="text-white/55 mb-8 leading-relaxed">
            30 Minuten, Einzelgespräch. Konkrete Einschätzung für Ihr Hotel — kein Pitch, kein Projektangebot.
          </p>
